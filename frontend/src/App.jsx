    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors duration-500">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <main className="relative">
          ...
          <div className="absolute -top-6 -left-12 w-24 h-24 bg-blue-200 dark:bg-blue-800 rounded-full mix-blend-multiply dark:mix-blend-normal opacity-30 animate-blob blur-xl -z-10"></div>
          <div className="absolute top-0 -right-12 w-24 h-24 bg-purple-200 dark:bg-purple-800 rounded-full mix-blend-multiply dark:mix-blend-normal opacity-30 animate-blob animation-delay-2000 blur-xl -z-10"></div>
          <div className="absolute -bottom-8 left-20 w-24 h-24 bg-pink-200 dark:bg-pink-800 rounded-full mix-blend-multiply dark:mix-blend-normal opacity-30 animate-blob animation-delay-4000 blur-xl -z-10"></div>
                  ...
                  <div className="ml-4">
                    ...
                    <div className="mt-4">
                      <button
                        type="button"
                        onClick={handleReset}
                        className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-300"
                      >
